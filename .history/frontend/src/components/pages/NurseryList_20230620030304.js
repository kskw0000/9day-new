...
function NurseryList({ setSelectedNursery }) {
  ...
  const firstRowNurseries = filteredNurseries.slice(0, filteredNurseries.length - 7);
  const secondRowNurseries = filteredNurseries.slice(filteredNurseries.length - 7);
